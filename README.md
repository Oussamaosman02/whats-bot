...
Limits: 15 s cooldown, 3 `/resumen` per user per day (admins exempt), unknown periods are refused with examples instead of guessed. Spanish by default (`BOT_LANGUAGE`), times in `BOT_TIMEZONE`.
